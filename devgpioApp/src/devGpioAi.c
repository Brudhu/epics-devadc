...
static long devGpioInitRecord_ai( aiRecord *prec );
static long devGpioRead_ai( aiRecord *prec );

/*_____ G L O B A L S ________________________________________________________*/
devGpio_dset_t devGpioAi = {
  6,
  NULL,
  devGpioInit,
  devGpioInitRecord_ai,
  devGpioGetIoIntInfo,
  devGpioRead_ai,
  NULL
};
epicsExportAddress( dset, devGpioAi );
 ...
 * @return  In case of error return -1, otherwise return 0
 *----------------------------------------------------------------------------*/
long devGpioRead_ai( aiRecord *prec ) {
